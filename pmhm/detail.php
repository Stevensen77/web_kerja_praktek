  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
		 ...
		 <img src="images/logo2.jpg" width="120" height="120" style="opacity: 0.8;">
	      ...
	      <div class="collapse navbar-collapse" id="cssmenu">
	       <ul class="navbar-nav ml-auto">
			  <p style="font-size:30px;margin-left:-300px;color:#da1919">PT.PUNCAK MENARA HIJAU MAS</p>
      ...
      <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            <h1 class="mb-4 bread">Spesification Product</h1>
            </div>
          </div>
        </div>
      </div>
          	...
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
          			...
          			<div class="single-slider owl-carousel">
          				<div class="item">
          					<div class="room-img" style="background-image: url(images/cutting.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="room-img" style="background-image: url(images/grain.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="room-img" style="background-image: url(images/rak.jpg);"></div>
          				</div>
          			</div>
          		</div>
...
<footer class="ftco-footer ftco-bg-dark ftco-section" style="height:450px;margin-top:-100px">
            ...
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                ...
	                <li><span class="text">Jalan Griya Agung Blok O No.71,<br> Kompleks Pertokoan Griya Inti Sentosa<br>Jakarta Utara<br>Post Code 14350<br>Indonesia</span></li>
					<li><a href="#"><span class="text"> puncakmenarahijaumas@gmail.com</span></a></li>
	                <!--  <li><a href="#"><span class="icon icon-phone"></span><span class="text">08 - </span></a></li> -->
	...
	Copyright &copy;2019 All rights reserved | PT.Puncak Menara Hijau Mas
	  ...
	  <a href="https://colorlib.com" target="_blank" style="float:right;font-size:20px;color:#0a0a29;margin-top:-50px">Colorlib</a>
