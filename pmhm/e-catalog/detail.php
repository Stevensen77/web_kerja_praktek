			...
			<form class="" action="cart.php" method="post" enctype="multipart/form-data">
					...
					?>
						...
						<div class="details_image_thumbnails d-flex flex-row align-items-start justify-content-between">
							<div class="details_image_thumbnail active" data-image="<?php echo '<img width="200px" src="'.$result['link_gambar'].'"/>'; ?>" ><?php echo '<img width="200px" src="'.$result['link_gambar'].'"/>'; ?></div>
					...
					<div class="details_content">
						...
						<div class="in_stock_container">
							...
							<div class="product_quantity clearfix">
								...
								<span>Qty</span>
								<input id="quantity_input" type="text" pattern="[0-9]*" name="kuantitas_pesan" value="" requireds>
							...
							title="Product is out of stock" value="Out of stock! You must PreOrder" style="color:red;width:300px" disabled <?php   } ?> 
							...
							<?php if ($result['stok_produk'] == '0'){ ?>
							<input type="submit" class="button" name="submit1" 
							title="Product is out of stock" value="PreOrder" style="color:green;width:100px" <?php   } ?>
							</input>
				...
				<div class="col-lg-8 offset-lg-2">
					<div class="newsletter_content text-center">
						...
						<div class="newsletter_form_container">
							<form action="mailto:rubberwood@pt-pmhm.com" id="newsletter_form" class="newsletter_form">
								<input type="textarea" class="newsletter_input" required="required">
