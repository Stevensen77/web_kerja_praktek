<section class="ftco-section ftc-no-pb ftc-no-pt empat" style="background-color:#e9e4e9;height:350px;margin-top:-20px">
			<div class="container">
			<div class="row">
			...
			<div class="col-md-7 py-5 wrap-about pb-md-5 " style="">
	          <div class="heading-section heading-section-wo-line pt-md-5 pl-md-5 mb-5">
	          	<div class="ml-md-0">
		            ...
		            <h2 class="mb-4" style="margin-top:-78px;margin-left:-45px">Core</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
...
<!-- ================================================================================================================================================ -->				
		...
		<section class="ftco-section ftc-no-pb ftc-no-pt empat" style="background-color:#e9e4e9;height:350px;margin-top:-20px">
			...
			<?php
					$db = mysqli_connect("localhost","root","","pmhm"); //keep your db name
					$sql = "SELECT * FROM produk WHERE kategori ='face back'";
					$sth = $db->query($sql);
					$result=mysqli_fetch_array($sth);
					// '<img src="data:image/jpeg;base64,'.base64_encode( $result['gambar'] ).'" 
				?>
			...
			<div class="col-md-7 py-5 wrap-about pb-md-5 " style="">
	          <div class="heading-section heading-section-wo-line pt-md-5 pl-md-5 mb-5">
	          	<div class="ml-md-0">
		            ...
		            <h2 class="mb-4" style="margin-top:-78px;margin-left:-45px">Face / Back</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
							<p style="margin-top:-60px">PT. Puncak Menara Hijau Mas has been serving wood industries both in Indonesia and overseas since 1997. 
